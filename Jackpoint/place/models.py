...
class CategoriePlace(models.Model):
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Place_Categorie_Admin")
...
class Url(models.Model):
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Place_URL_Admin")
    Date =  models.DateTimeField(auto_now_add=True, blank=True)
    def __unicode__(self):
...
class Avis(models.Model):
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Place_Avis_Admin")
    Date =  models.DateTimeField(auto_now_add=True, blank=True)
...
class Place(models.Model):
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Place_Place_Admin")
    Date =  models.DateTimeField(auto_now_add=True, blank=True) 
    def __unicode__(self):
        return str(self.Nom)

class PlaceOld(models.Model):
    Nom = models.TextField(max_length=1024, null=True, blank=True)
    Categorie = models.ManyToManyField('CategoriePlace', null=True, blank=True)
    Texte = models.TextField(max_length=1024, null=True, blank=True)
    Url = models.ManyToManyField('Url', null=True, blank=True)
    ...
    Createur = models.ForeignKey('jack.Createur',null=True, blank=True)
    Editeur = models.ForeignKey('jack.Editeur',null=True, blank=True)    
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Place_PlaceOld_Admin")
    Date =  models.DateTimeField(auto_now_add=True, blank=True)
    def __unicode__(self):
        return str(self.Nom)
