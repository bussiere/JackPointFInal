...
class CategorieInvitation(models.Model):
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Invitation_Categorie_Admin")
    Date = models.DateTimeField(auto_now_add=True, blank=True)

class Usage(models.Model):
    Nom = models.CharField(max_length=128, null=True, blank=True)
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Invitation_Usage_Admin")
    Date = models.DateTimeField(auto_now_add=True, blank=True)
...
class Invitation(models.Model):   
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Invitation_Invitation_Admin")
    Date = models.DateTimeField(auto_now_add=True, blank=True)
    # a revoir
...
class InvitationUsed(models.Model):   
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Invitation_InvitationUsed_Admin")
    Date = models.DateTimeField(auto_now_add=True, blank=True)
    def __unicode__(self):
        return self.Code
    # a revoir
