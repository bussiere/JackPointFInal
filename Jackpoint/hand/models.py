...
class Question(models.Model):  
    ...
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Hand_Question_Admin")
...
class Answer(models.Model):  
    ...
    Date = models.DateTimeField(auto_now_add=True, blank=True)
    Administration = models.ManyToManyField("administration.Administration",null=True, blank=True,related_name="Hand_Question_Answer")